  ...
  render() {
    return (
      <div>
        ...
        <div>
          <p className="cool">
            React Metro is a tiny configurable wrapper for animating dom elements as
            they mount or unmount
          </p>
          * Optional hooks for binding methods to sequence end and start.<br />
          * Ships with a simple fade in/out animation but everything can be overriden
          by either providing generic default animation override or a index based
          animationMap<br />
        </div>

        <p className="code">import {"Metro"} from 'react-metro'</p>
